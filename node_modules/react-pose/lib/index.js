...
var handleChildrenTransitions = (function (props, state) { return (tslib_1.__assign({ hasMounted: true }, handleTransition(props, state))); });
...
var Transition = (function (_super) {
    ...
    Transition.prototype.removeChild = function (key) {
        ...
        var newState = enterAfterExit
            ? tslib_1.__assign({ finishedLeaving: {} }, handleChildrenTransitions(tslib_1.__assign({}, this.props, { enterAfterExit: false }), tslib_1.__assign({}, this.state, { children: targetChildren }))) : {
            finishedLeaving: {},
...
var PoseGroup = (function (_super) {
    ...
    PoseGroup.prototype.render = function () {
        ...
        return React.createElement(Transition, tslib_1.__assign({}, props), children);
    };
