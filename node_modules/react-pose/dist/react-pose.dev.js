(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var getPoseValues = function (_a) {
        var transition = _a.transition, delay = _a.delay, delayChildren = _a.delayChildren, staggerChildren = _a.staggerChildren, staggerDirection = _a.staggerDirection, afterChildren = _a.afterChildren, beforeChildren = _a.beforeChildren, preTransition = _a.preTransition, applyAtStart = _a.applyAtStart, applyAtEnd = _a.applyAtEnd, props = __rest(_a, ["transition", "delay", "delayChildren", "staggerChildren", "staggerDirection", "afterChildren", "beforeChildren", "preTransition", "applyAtStart", "applyAtEnd"]);
        return props;
    };
    ...
    var poseFactory = function (_a) {
        ...
        return function (config) {
            ...
            var passive = config.passive, userSetValues = config.values, _b = config.initialPose, initialPose = _b === void 0 ? DEFAULT_INITIAL_POSE : _b;
            ...
            var api = {
                ...
                has: has,
                setProps: function (newProps) { return (state.props = __assign({}, state.props, newProps)); },
    ...
    ***************************************************************************** */
    ...
    var filterChildProps = function (_a) {
        var children = _a.children, _pose = _a._pose, onPoseComplete = _a.onPoseComplete, popFromFlow = _a.popFromFlow, props = __rest(_a, ["children", "_pose", "onPoseComplete", "popFromFlow"]);
        return props;
    };
    ...
    var handleTransition = function (_a, _b) {
        ...
        targetChildren.forEach(function (child) {
            var newChildProps = __assign({}, propsForChild, filterChildProps(child.props));
        ...
        leaving.forEach(function (key) {
            ...
            var newChild = cloneElement(child, __assign({ _pose: exitPose, onPoseComplete: function () { return scheduleChildRemoval(key); }, popFromFlow: flipMove }, propsForChild, filterChildProps(child.props)));
            var insertionIndex = prevKeys.indexOf(key);
            children.splice(insertionIndex, 0, newChild);
        });
        return { children: children };
    };
    var handleChildrenTransitions = (function (props, state) { return (__assign({ hasMounted: true }, handleTransition(props, state))); });
    ...
    var Transition = (function (_super) {
        ...
        Transition.prototype.removeChild = function (key) {
            var _a = this.state, children = _a.children, finishedLeaving = _a.finishedLeaving;
            ...
            var targetChildren = children.filter(function (child) { return !finishedLeaving.hasOwnProperty(child.key); });
            var newState = enterAfterExit
                ? __assign({ finishedLeaving: {} }, handleChildrenTransitions(__assign({}, this.props, { enterAfterExit: false }), __assign({}, this.state, { children: targetChildren }))) : {
                finishedLeaving: {},
    ...
    var PoseGroup = (function (_super) {
        ...
        PoseGroup.prototype.render = function () {
            ...
            return React.createElement(Transition, __assign({}, props), children);
        };
