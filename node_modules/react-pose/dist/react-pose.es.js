...
var handleTransition = function (_a, _b) {
    ...
    leaving.forEach(function (key) {
        ...
        var newChild = cloneElement$1(child, __assign({ _pose: exitPose, onPoseComplete: function () { return scheduleChildRemoval(key); }, popFromFlow: flipMove }, propsForChild, filterChildProps(child.props)));
...
var PoseGroup = (function (_super) {
    ...
    PoseGroup.prototype.render = function () {
        ...
        return createElement(Transition, __assign({}, props), children);
    };
